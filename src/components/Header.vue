  ...
  <header id="header">
        ...
        <div class="center">
            ...
            <div id="logo">
                ...
                <span id="brand"><strong>Curso</strong>Vue JS</span>
            </div>
            <!--Menu-->
            <nav id="menu">
                <ul>
                    ...
                    <li><router-link to="/formulario" active-class="active">Formulario</router-link></li>
                    <li><router-link :to="{name:'pagina', params:{id:'soy el valor del param'}}" active-class="active">Pagina </router-link></li>
